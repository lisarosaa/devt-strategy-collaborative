...
1. This user story was developed locally by __Sayed__ on a brach called `main-text`.
1. The new branch was pushed to the shared repository
1. A pull request was made to `master` & reviewed by the team
1. Changes were merged to `master`
...
1. This user story was developed locally by __ on a brach called `reference`.
1. The new branch was pushed to the shared repository
1. A pull request was made to `master` & reviewed by the team
1. Changes were merged to `master`
